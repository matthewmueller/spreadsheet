...
function Spreadsheet() {
  ...
  // bind events
  this.events = events(this.el, this);
  this.events.bind('click .editable', 'selectCell');

  // listen for the arrow keys
  this.keyboard = keyboard(document, this);
  ...
  this.docEvents.bind('keydown', 'onkeydown');
}
...
Spreadsheet.prototype.selectCell = function(e) {
  var target = e.target;
...
Spreadsheet.prototype.onkeydown = function(e) {
...
Spreadsheet.prototype.move = function(e, dir) {
  this.traverse(dir, function(cell) {
    if (cell.classes.has('editable') && !cell.classes.has('hidden')) {
      cell.active();
      return false;
    }
  });
