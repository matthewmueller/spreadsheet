...
var spreadsheet = domify('<table class="spreadsheet"><thead></thead><tbody></tbody></table>');
...
function Spreadsheet() {
  ...
  this.thead = this.el.firstChild;
  this.tbody = this.el.lastChild;
...
Spreadsheet.prototype.fill = function(cell) {
  ...
  colhead = colhead ? colhead : domify('<tr><th></th></tr>');
