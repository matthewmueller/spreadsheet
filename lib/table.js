...
Table.prototype.insert = function(at, cell) {
  var cells = {};
  var td;
  ...
  for (at in cells) {
    cell = cells[at];
    at = at.toUpperCase();
    cell = undefined == cell ? new Cell(null, at, this) : cell;
...
Table.prototype.fill = function(at) {
  var el = this.el;
  var m = match(at);
  var ac = lton(m[1]);
  var ar = +m[2];
...
// Table.prototype.focuscell = function(e) {
//   console.log('her...');
//   var target = e.target;
...
Table.prototype.onblur = function(e) {
  var target = e.target;
...
Table.prototype.at = function(at) {
  at = at.toUpperCase();
  return this.table[at] || null;
};
...
Table.prototype.find = function(at) {
